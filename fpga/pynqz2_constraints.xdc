...
# create_clock -period 8.0 -name sys_clk_pin [get_ports i_clk]
...
set_property PACKAGE_PIN N15               [get_ports { led_rgb_0[0] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[0] }]
set_property PACKAGE_PIN G17               [get_ports { led_rgb_0[1] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[1] }]
set_property PACKAGE_PIN L15               [get_ports { led_rgb_0[2] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[2] }]
set_property PACKAGE_PIN M15               [get_ports { led_rgb_0[3] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[3] }]
set_property PACKAGE_PIN L14               [get_ports { led_rgb_0[4] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[4] }]
set_property PACKAGE_PIN G14               [get_ports { led_rgb_0[5] }]
set_property IOSTANDARD LVCMOS33           [get_ports { led_rgb_0[5] }]

## UART0
set_property PACKAGE_PIN Y18               [get_ports { uart0_rx_0 }]
set_property IOSTANDARD LVCMOS33           [get_ports { uart0_rx_0 }]
set_property PACKAGE_PIN Y19               [get_ports { uart0_tx_0 }]
set_property IOSTANDARD LVCMOS33           [get_ports { uart0_tx_0 }]

## UART1
set_property PACKAGE_PIN W14               [get_ports { uart1_rx_0 }]
set_property IOSTANDARD LVCMOS33           [get_ports { uart1_rx_0 }]
set_property PACKAGE_PIN Y14               [get_ports { uart1_tx_0 }]
